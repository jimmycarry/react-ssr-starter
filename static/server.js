...
var _HelmetUtils = __webpack_require__(79);
...
function serverRenderer(_ref) {
    var clientStatus = _ref.clientStatus,
        serverStatus = _ref.serverStatus;

    return function (req, res, next) {
        var context = {};
        var markup = _server2.default.renderToString(React.createElement(
            _reactRouterDom.StaticRouter,
            { location: req.url, context: context },
            React.createElement(_App.App, null)
        ));
        var helmet = _reactHelmet.Helmet.renderStatic();
        res.status(200).send((0, _template2.default)({ markup: markup, helmet: helmet }));
    };
}
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(_reactRouterDom.Route, { path: '/about', component: _AboutPage.AboutPage })
                )
            );
        }
    }]);
...
module.exports = {"container":"homepage__container_9QkSa"};
